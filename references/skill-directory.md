...
This file is the generated index surface for sub-skills and references.
It root SKILL.md loads this at runtime only when needed, not at entry.
...
- [`references/team-mode-matrix.json`](team-mode-matrix.json)
- [`references/expert-subagent-library.json`](expert-subagent-library.json)
- [`references/subagent-topology-matrix.json`](subagent-topology-matrix.json)
- [`references/check-lens-matrix.json`](check-lens-matrix.json)
