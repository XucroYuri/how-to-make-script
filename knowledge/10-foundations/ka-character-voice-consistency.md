...
角色声音最容易被误写成“会不会说金句”或者“有没有几个明显口头禅”。这两件事都不等于声纹。一套真正可持续的角色声纹，通常来自更深的东西：这个人怎么看世界、在乎什么、怕失去什么、习惯用什么方式保护自己。
...
- [ ] 角色声纹的一致性，和角色在成长弧里发生语言变化之间，边界应该如何定义？
- [ ] 哪些类型片角色天然允许更强的风格化表达，而不会被视为“失真”？
- [ ] 多角色群像戏里，是否需要单独建立“角色间语言区分度”的量化检查？
- [ ] 当演员表演能力、明星 persona 或配音条件会反向塑造声纹时，这一原子需要如何扩展？
