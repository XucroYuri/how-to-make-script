...
- [ ] 角色声音的一致性，和角色在成长弧里发生语言变化之间，边界应该如何定义？
- [ ] 哪些类型片角色天然允许更强的风格化表达，而不会被视为“失真”？
- [ ] 多角色群像戏里，是否需要单独建立“角色间语言区分度”的量化检查？
- [ ] 当演员表演能力、明星 persona 或配音条件会反向塑造角色声音时，这一原子需要如何扩展？
- [ ] 怎样防止 Agent 把“低教育程度 / 高情绪波动 / 强压迫处境”误写成刻板语言标签？
- [ ] 当角色故意伪装、表演或说违心话时，仓库应如何记录“表层声音”和“深层声音”的双层模型？
