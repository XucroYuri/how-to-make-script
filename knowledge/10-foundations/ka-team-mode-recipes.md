...
- [ ] 【电影开发小组】独立电影、流媒体平台片和传统 studio feature 是否需要三套不同 pod 变体？
- [ ] 【电影开发小组】当导演尚未加入时，feature pod 的最终收束角色应该是谁？
- [ ] 【电影开发小组】哪些 feature 开发阶段最适合 parallel lanes，哪些阶段反而应极度收窄？
- [ ] 【剧集编剧室】长剧、迷你剧、短剧的 room cadence 是否需要独立模式？
- [ ] 【剧集编剧室】当平台给出强命题时，showrunner room 的发散空间应如何缩窄？
- [ ] 【剧集编剧室】哪些 episode-level 工作最值得下放给 specialist，哪些必须永远由 showrunner 守住？
- [ ] 【动画 Story Trust】动画长片、动画剧集、学龄前动画是否需要不同 trust loop？
- [ ] 【动画 Story Trust】仓库是否需要单独增加 reel-feedback 与 story-sketch 相关资产，而不只是文本产物？
- [ ] 【动画 Story Trust】哪些动画问题实际上更像 layout/acting 问题，不应硬塞回剧本团队？
- [ ] 【品牌内容工作室】高端品牌片、功能型短视频、社媒 campaign 是否需要三套不同 studio loop？
- [ ] 【品牌内容工作室】当品牌方内部 stakeholder 太多时，review board 应如何设计才不压死创意 lane？
- [ ] 【品牌内容工作室】哪些品牌内容必须先做 audience fit，再谈创意方向？
- [ ] 【互动分支实验室】不同互动容器，例如 visual novel、RPG 支线、叙事手游事件，是否需要不同 lab 节奏？
- [ ] 【互动分支实验室】仓库是否要进一步支持 automated branch test artifact，而不仅是地图和文本产物？
- [ ] 【互动分支实验室】玩家数据回流进入 rewrite loop 时，interactive_branch_lab 应如何变化？
