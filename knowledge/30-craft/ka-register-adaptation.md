...
所以语体不是装饰层，而是匹配层。它必须同时回答几个问题：谁在说、对谁说、通过什么媒介说、为什么要这么说、说到什么程度会开始假。只写一个“更自然”“更高级”“更有质感”，对 Agent 基本没有可执行价值。

更实用的方式，是给出一个语言区间。比如“允许冷静克制，但不允许奢侈品空话”“允许短句和打断，但不能像社交媒体抖机灵”“允许品牌价值感，但不能牺牲可感知的生活细节”。这样风格才会真的落地，而不是停在评价词上。

## TODOs：待回答问题

- [ ] 语体适配是否需要进一步拆成“角色台词”“场景描述”“宣传文案”“互动提示”四套独立规则？
- [ ] 当项目横跨多个平台版本时，仓库是否需要记录一套主语域和若干派生语域？
- [ ] 不同文化区、不同语言环境下，“自然”“高级”“真实”的语感阈值差异该如何编码？
- [ ] 诗性、强作者风格、类型化程式语言在什么条件下是优势，而不是 fake 感来源？
- [ ] 对品牌内容来说，语域适配和品牌定位之间如何避免互相绑死，导致文本高度同质化？
- [ ] 当角色设定与平台流行表达天然冲突时，Agent 应优先保角色还是保平台适配？
