...
This repository should not expose every advanced route on the first pass of an ordinary screenplay request.

The design goal is progressive power, not permanent maximalism.
