...
各契约职责：表达契约让 voice、register 与连续性成明确质量维度；视觉语言契约理跨语言镜头词汇；屏幕到视频桥接层分离剧本写作与下游制作语法；团队契约建模多智能体协作；专家阵容契约允有限范围专家 subagent 不膨为永久团队；质量关卡契约实现自适应自审；研究背景契约让广剧作理论需求成一等公民。
