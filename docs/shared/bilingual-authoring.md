...
- Public concept naming should follow [`docs/canonical-term-policy.md`](./canonical-term-policy.md) and [`docs/shared/canonical-term-register.json`](./canonical-term-register.json).
