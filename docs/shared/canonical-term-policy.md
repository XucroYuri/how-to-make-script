...
- [`docs/shared/canonical-term-register.json`](./canonical-term-register.json)
...
The register in [`docs/shared/canonical-term-register.json`](./canonical-term-register.json) is the source of truth for banned or migration-sensitive terms.
